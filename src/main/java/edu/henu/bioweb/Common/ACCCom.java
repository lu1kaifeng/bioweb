...
public class ACCCom {
    public boolean isExistByGene(String strGene, String strGSE) {
        ...
        try {
            ...
            obj = (Object) ctx.lookup("jdbc/SSACC");
            ds = (DataSource) obj;
    ...
    public String GetPath(String strSql, String strSplit, String strPath, String strGen, String strAvg, String strSurvival, String strDB, String strCancer, String tip) throws RserveException, REXPMismatchException {
        ...
        if (strSql.equals("-1")) {
            ...
            strTip = fun.GetTip(3, tip, strGen, "ACC");//"Number of ACC patients was less than 4 in "+tip+", No meaningful output.";
            return strTip;
        }
        ...
        try {
            ...
            int i = x.asInteger();
            if (i < 4 && i > 0) {
                strTip = fun.GetTip(2, tip, strGen, "ACC");
                return strTip;
            } else if (i == 0) {
                strTip = fun.GetTip(3, tip, strGen, "ACC");
                return strTip;
            } else {
                strTip = " ";
            }
