...
public class AMLCom {
	...
	public boolean isExistByGene(String strGene, String strGSE){
        ...
        try {
        	...
        	obj = (Object)ctx.lookup("jdbc/SSAML");
            ds = (DataSource)obj;
	...
	public String GetRString(String strSql, String strSurvival, String res, String strDB)
	{
        ...
        try {
        	initCtx = new InitialContext();
        	ctx = (Context)initCtx.lookup("java:comp/env");
        	obj = (Object)ctx.lookup("jdbc/SSAML");//jdbc/SSBRCA2
            ds = (DataSource)obj;
	...
	{	
		...
		if(strSql.equals("-1"))
		{
			...
			strTip = fun.GetTip(3, tip, strGen, "AML");//"Number of AML patients was less than 4 in "+tip+", No meaningful output.";
            return strTip;
		}
        ...
        try {   
            ...
            if(i<4 && i>0)
            {            	
            	strTip = fun.GetTip(2, tip, strGen, "AML");
                return strTip;
            }
            else if(i==0)
            {
            	strTip = fun.GetTip(3, tip, strGen, "AML");
                return strTip;
            }
            else
            {
