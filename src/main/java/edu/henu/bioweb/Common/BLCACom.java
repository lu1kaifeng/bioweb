...
public class BLCACom {
    ...
    public GetPathReturn GetPath(String strSql, String strSplit, String strPath, String strGen, String strAvg, String strSurvival, String strDB, String strCancer, String tip) throws RserveException, REXPMismatchException {
        ...
        if (strSql.equals("-1")) {
            ...
            strTip = fun.GetTip(3, tip, strGen, "BLCA");//"Number of BLCA patients was less than 4 in "+tip+", No meaningful output.";
            return new GetPathReturn(strTip);
        }
        ...
        return new GetPathReturn(bytes, strTip);
    }
