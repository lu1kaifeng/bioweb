...
public class LUCACom {
	...
	public boolean isExitGene(String strGene, String strDB, String strGSE){
        ...
        try {
        	initCtx = new InitialContext();
        	ctx = (Context)initCtx.lookup("java:comp/env");
        	obj = (Object)ctx.lookup("jdbc/"+strDB);
            ds = (DataSource)obj;
	...
	{	
		...
		if(strSql.equals("-1"))
		{
			...
			strTip = "Number of LUCA patients was less than 4 in "+tip+", No meaningful output.";
            return strTip;
		}
