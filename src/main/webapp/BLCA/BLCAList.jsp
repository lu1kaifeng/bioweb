...
<body><div  style="font-size: 18px;background:#747070;">
    ...
    <div class="panel panel-default">
         ...
         <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
             ...
             <form id="BLCATCGAForm" method="post" action="../BLCATCGA">
            <%-- <%
		String strIP = "";
	    ...
	    String sql = "insert into userAccess(userIP,userAddress) values('"+strIP+"','blca')";
	    try {
		...
		%>--%>
             <table style="width:925px;border-collapse:separate; border-spacing:10px 10px;margin:auto;">
                ...
                <tr>
                    ...
                    <td>
                    	<input id="txtGen" type="text" class="form-control" style="width:150px;display:inline" name="txtGen" value="<%=(String)request.getAttribute("txtGen")!=null?(String)request.getAttribute("txtGen"):""%>" />
                ...
                <tr>
                    ...
                    <td>
                    	<select id="ddldata" style="width:auto;" name="ddldata" onchange="window.location=this.value" class="form-control">
                    		...
                    		<option value="/BLCA/BLCAList.jsp" selected="selected">TCGA</option>
