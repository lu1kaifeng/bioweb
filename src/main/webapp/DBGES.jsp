...
<body><div  style="font-size: 18px;background:#747070;">
    ...
    <div class="panel panel-default">
         ...
         <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
             ...
             <form id="loginForm" method="post" action="GESR">
             <table style="width:925px;margin:auto;border-collapse:separate; border-spacing:10px 10px;">
                ...
                <tr>
                    ...
                    <td>
                    	<select id="ddldata" name="ddldata" style="width:auto;" onChange="window.location=this.value" class="form-control">
                    		<option value="DBGES.jsp" selected="selected">GSE53625</option>
    		...
    		<tr>
    			<td style="width:900px;">
    				<div style="width:500px;margin:auto;padding-top:10px;">
    					<img src="<%=(String)request.getAttribute("myimg")%>" name="myimg" style="width:500px;height:500px;border:none;" />
    				</div>
    			</td>
    		</tr>
			<%
              	  ...
              	  <tr>
              	  	<td style="width:900px;">
              	  		<div style="width:500px;margin:auto;">
              	  			<img src="<%=strs[i]%>" style="width:500px;height:500px;" />
              	  		</div>
              	  	</td>
              	  </tr>
			  <%}}
